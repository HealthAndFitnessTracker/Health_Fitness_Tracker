...
class Measurements():
    def __init__(self, Weight:int, Chest:int, Chest_height:int, Left_arm:int, Left_arm_height:int, Right_arm:int, Right_arm_height:int, Stomach:int, Stomach_height:int, Hips:int, Hips_height:int, Left_thigh:int, Left_thigh_height:int, Right_thigh:int, Right_thigh_height:int, Time:Date()):
        self.weight = Weight
        self.chest = Chest
